...
public interface FoodMapper {
    ...
    @Insert("INSERT INTO food_info(`foodName`,`picUrl`,`foodPrice`,`shopId`,`cateId`,`paixu`,`uTime`) VALUES (#{foodName},#{picUrl,jdbcType=VARCHAR},#{foodPrice},#{shopId},#{cateId},#{paixu},NOW())")
